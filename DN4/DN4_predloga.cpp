...
int main() {
    ...
    for (int iitt = 0; iitt < 2000; iitt++)
    {
      ...
      ===================================================================================
      Klasične Gauss-Seidlove metode ni mogoče paralelizirati, saj se vsaka nova vrednost
      neznanke izračuna z uporabo že posodobljenih vrednosti iz iste iteracije. Zaradi teh
      medsebojnih odvisnosti izračuna ni mogoče razdeliti na neodvisne korake, ki so 
      bistveni za paralelizacijo.
      ===================================================================================
        */
